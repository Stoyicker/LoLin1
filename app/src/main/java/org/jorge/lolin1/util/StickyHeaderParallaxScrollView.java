...
/**
 * @author Emil Sjölander - sjolander.emil@gmail.com
 *         All rights of this class belong to the aforementioned author.
 */
public class StickyHeaderParallaxScrollView extends ParallaxScrollView {
    ...
    public StickyHeaderParallaxScrollView(Context context, AttributeSet attrs) {
